...
"__kernel\n"
"void vPrint()\n"
"{ int local_x = get_local_id(2);\n"
"int local_y = get_local_id(1);\n"
"int local_z = get_local_id(0);\n"
"int group_x = get_group_id(2);\n"
"int group_y = get_group_id(1);\n"
"int group_z = get_group_id(0);\n"
"printf(\"Hello World! My groupId is %dx%dx%d and local threadId is %dx%dx%d\\n\",group_x, group_y, group_z, local_x, local_y, local_z);\n"
"}\n";
#elif defined THREE
const char *mykernel =
"__kernel\n"
...
"printf(\"Hello World! My groupId is %dx%d and local threadId is %dx%d\\n\",group_x, group_y, local_x, local_y);\n"
"}\n";
#elif defined TWO
const char *mykernel =
"__kernel\n"
...
"printf(\"Hello World! My threadId is %dx%d\\n\", index_x, index_y);\n"
"}\n";
#else
const char *mykernel =
"__kernel\n"
...
int main(int argc, char *argv)
{
	...
	cl_kernel kernel = clCreateKernel(program, "vPrint", &err);

#if defined FOUR
        size_t n_workitem[] = {8, 8, 4};
